...
public class indexController {
     ...
     * 2、如果鼠标上移到大分类，则加载其子分类的内容，如果存在子分类，则不需要再次加载；
     */
    ...
    @ApiOperation(value="查询一级分类下的6条最新商品记录",notes = "查询一级分类下的6条最新商品记录",httpMethod = "GET")
    ...
    public IMOOCJSONResult sixNewItems(
        ...
        List<NewItemsVO> sixNewImtesLazy = categoryService.getSixNewImtesLazy(rootCatId);
        return  IMOOCJSONResult.ok(sixNewImtesLazy);
    }
}
